...
//
//			const glm::vec3 a = bodyA->BodySpaceToWorldSpace(contact.ptOnA_LocalSpace);
//			const glm::vec3 b = bodyB->BodySpaceToWorldSpace(contact.ptOnB_LocalSpace);
//
...
//
//			const glm::vec3 oldA = bodyA->BodySpaceToWorldSpace(m_contacts[i].ptOnA_LocalSpace);
//			const glm::vec3 oldB = bodyB->BodySpaceToWorldSpace(m_contacts[i].ptOnB_LocalSpace);
//
//			const glm::vec3 newA = contact.bodyA->BodySpaceToWorldSpace(contact.ptOnA_LocalSpace);
//			const glm::vec3 newB = contact.bodyB->BodySpaceToWorldSpace(contact.ptOnB_LocalSpace);
//
