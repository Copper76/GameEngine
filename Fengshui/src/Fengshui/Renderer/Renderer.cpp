...
//		uint32_t TextureSlotIndex = 1;
//
//		std::array<std::array<uint32_t, 4>, 6> CubeVertexPositionMap;
...
//
//		//s_Data.ShapeIndexBuffer = IndexBuffer::Create(s_Data.MaxIndices, s_Data.ShapeIndexBufferPtr);
...
//
//		s_Data.CubeVertexPositionMap[0] = { 0, 1, 2, 3 };
//		s_Data.CubeVertexPositionMap[1] = { 1, 5, 6, 2 };
//		s_Data.CubeVertexPositionMap[2] = { 5, 4, 7, 6 };
//		s_Data.CubeVertexPositionMap[3] = { 4, 0, 3, 7 };
//		s_Data.CubeVertexPositionMap[4] = { 3, 2, 6, 7 };
//		s_Data.CubeVertexPositionMap[5] = { 4, 5, 1, 0 };
//	}
//
//	void Renderer::Shutdown()
//	{
...
//	{
//
//		if (s_Data.ShapeIndexCount >= RendererConfig::MaxIndices || s_Data.ShapeVertexCount >= RendererConfig::MaxVertices)
//		{
//			Flush();
//			PrepareNextBatch();
//		}
...
//			{
//				uint32_t index = s_Data.CubeVertexPositionMap[face][i];
//				s_Data.ShapeVertexBufferPtr->Position = transform * s_Data.CubeVertexPositions[index];
//				s_Data.ShapeVertexBufferPtr->Colour = colour;
//				//s_Data.ShapeVertexBufferPtr->Colour = { i / 8.0f,i / 8.0f,i / 8.0f, 1.0f };
//				s_Data.ShapeVertexBufferPtr->TexCoord = texCoords[i];
//				s_Data.ShapeVertexBufferPtr->TextureIndex = textureIndex;
