...
namespace Fengshui
{
	...
	public:
		...
		static void DrawQuad(const glm::mat4 transform, const float tilingFactor = 1.0f, const Ref<Texture2D>& texture = nullptr, const glm::vec2* texCoords = nullptr, const glm::vec4& colour = { 1.0f, 1.0f, 1.0f, 1.0f });
