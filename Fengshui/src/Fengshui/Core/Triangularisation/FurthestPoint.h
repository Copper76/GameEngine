...
namespace Fengshui
{
	static int FindPointFurthestInDir(const glm::vec3* pts, const int num, const glm::vec3& dir) {
		int maxIdx = 0;
	...
	static float DistanceFromLine(const glm::vec3& a, const glm::vec3& b, const glm::vec3& pt) {
	...
	static glm::vec3 FindPointFurthestFromLine(const glm::vec3* pts, const int num, const glm::vec3& ptA, const glm::vec3& ptB) {
		int maxIdx = 0;
	...
	static float DistanceFromTriangle(const glm::vec3& a, const glm::vec3& b, const glm::vec3& c, const glm::vec3& pt) {
		glm::vec3 ab = b - a;
		glm::vec3 ac = c - a;
	...
	static glm::vec3 FindPointFurthestFromTriangle(const glm::vec3* pts, const int num, const glm::vec3& ptA, const glm::vec3& ptB, const glm::vec3& ptC) {
		int maxIdx = 0;
	...
	static void BuildTetrahedron(const glm::vec3* verts, const int num, std::vector<glm::vec3>& hullPts, std::vector<Triangle>& hullTris) {
		hullPts.clear();
		hullTris.clear();
	...
	static void RemoveInternalPoints(const std::vector<glm::vec3>& hullPoints, std::vector<Triangle>& hullTris, std::vector<glm::vec3>& checkPts) {
	...
	static bool IsEdgeUnique(const std::vector<Triangle>& tris, const std::vector<int>& facingTris, const int ignoreTri, const Edge& edge) {
	...
	static void AddPoint(std::vector<glm::vec3>& hullPoints, std::vector<Triangle>& hullTris, glm::vec3& pt) {
	...
	static void RemoveUnreferencedVerts(std::vector<glm::vec3>& hullPoints, std::vector<Triangle>& hullTris) {
	...
	static void ExpandConverHull(std::vector<glm::vec3>& hullPoints, std::vector<Triangle>& hullTris, const std::vector<glm::vec3>& verts) {
	...
	static bool IsExternal(const std::vector< glm::vec3 >& pts, const std::vector<Triangle>& tris, const glm::vec3& pt) {
		bool isExternal = false;
	...
	*/
	static float TetrahedronVolume(const glm::vec3& a, const glm::vec3& b, const glm::vec3& c, const glm::vec3& d) {
	...
	static glm::mat3 InertiaTensorTetrahedron(const glm::vec3& ptA, const glm::vec3& ptB, const glm::vec3& ptC, const glm::vec3& ptD) {
	...
	static glm::vec3 CalculateCenterOfMass(const std::vector<glm::vec3>& pts, const std::vector<Triangle>& tris) {
	...
	static glm::mat3 CalculateInertiaTensor(const std::vector<glm::vec3>& pts, const std::vector<Triangle>& tris, const glm::vec3& cm) {
